...
namespace D.Diagram.Presenter
{
    ...
    public abstract class AddNodeCommand : AddNodeCommandBase
    {
        ...
        {
            D.Diagram.DrawingBox.Diagram diagram = fromNode.GetParent<D.Diagram.DrawingBox.Diagram>();
            if (diagram == null)
                return;
        ...
        protected virtual void CreateLink(D.Diagram.DrawingBox.Diagram diagram, Node from, Node to)
        {
